...
class Jellyfin(Media):
    ...
    def _login(self):
        ...
        """
        try:
            url = "{}/Users/AuthenticateByName".format(self._host)
    ...
    def _register_device(self):
        ...
        """
        try:
            url = "{}/Sessions/Capabilities/Full".format(self._host)
            headers = self._get_headers()
            body = {
    ...
    def _connect_websocket(self):
        ...
        while True:
            try:
                # 构造 WebSocket URL
                websocket_url = (self._host.replace("http", "ws") + "/socket?api_key="
    ...
    def _get_all_sessions(self):
        ...
        try:
            ...
            if len(self._block_devices) <= 0:
                return True
            url = "{}/Sessions".format(self._host)
            headers = self._get_headers()
    ...
    def _session_playing_stop(self, session_id):
        ...
        """
        try:
            url = "{}/Sessions/{}/Playing/Stop".format(self._host, session_id)
            headers = self._get_headers()
            body = {
                "Command": "Stop",
                "SeekPositionTicks": 0,
    ...
    def _session_playing(self, session_id):
        ...
        """
        try:
            url = "{}/Sessions/Playing".format(self._host)
            headers = self._get_headers()
            body = {
                "CanSeek": True,
    ...
    def _session_play_progress(self, session_id, position_ticks, total_ticks, is_paused=False, is_muted=False):
        ...
        """
        try:
            url = "{}/Sessions/Playing/Progress".format(self._host)
            headers = self._get_headers()
            body = {
                "CanSeek": True,
                "ItemId": self._play_item["Id"],
    ...
    def _session_play_stopped(self, session_id, position_ticks, is_paused=False, is_muted=False):
        ...
        """
        try:
            url = "{}/Sessions/Playing/Stopped".format(self._host)
            headers = self._get_headers()
            body = {
                "CanSeek": True,
                "ItemId": self._play_item["Id"],
    ...
    def _set_if_watched(self, watched):
        ...
        """
        try:
            url = "{}/Users/{}/PlayedItems/{}".format(self._host, self._user_id, self._play_item["Id"])
            headers = self._get_headers()
            if watched:
    ...
    def _session_send_message(self, session_id, header, message, timeout_ms):
        ...
        """
        try:
            url = "{}/Sessions/{}/Message".format(self._host, session_id)
            headers = self._get_headers()
            body = {
                "Id": "Stop",
                "Text": message,
    ...
    def _run_player(self):
        ...
        if container == 'BluRay':
            ...
            if 'mkv' in container or 'mp4' in container:
                ...
                container = 'other'
        return self._player.play(self._play_item["Path"], container,
