...
def initialize_components(config):
    ...
    try:
        ...
        priPlayer = initialize_component("PriPlayer", config, PlayerException)
        subPriPlayer = initialize_component("SubPriPlayer", config, PlayerException)
        ...
        if media_config and "Executor" in media_config:
            ...
            media = media_class(player, tv, av, media_config, subPlayer, priPlayer, subPriPlayer)
